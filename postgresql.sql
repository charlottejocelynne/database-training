...
-- membuat tabel barang yg berisi kolom kode, nama, harga, jumlah, dan waktu pada saat dibuat
create table barang
(
    kode         int          not null,
...
-- membuat tabel products yg berisi kolom id, name, description, price, quantity, dan created at
...
--memasukan value pada tabel products
...
-- menambahkan primary key tabel products
...
-- menggunakan where clause untuk menampilkan baris yang pricenya 20000
select id, name, price, quantity
from products
where price = 20000;

-- menggunakan where clause untuk menampilkan baris yang id nya P0004
select id, name, price, quantity
from products
where id = 'P0004';
...
-- membuat tipe data enum untuk kategori
...
-- menghapus baris pada data products
delete
from products
where id = 'P0009';
...
-- membuat tabel lain bernama admin
create table admin
(
    id         serial       not null,
